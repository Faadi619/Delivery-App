...
import 'package:app_876/ui/Screens/CustomerSideApp/AuthScreens/GetLocationScreen.dart';
  ...
  Future<void> verifyOtp({
    ...
    try {
      ...
      await auth
        ...
        customerUserModel.uid = credential.user!.uid;
        notifyListeners();

        await customerDataToFirebase(gender: gender, finalphone: finalphone);
