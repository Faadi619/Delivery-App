...
import '../GetBusinessLocationScreen/GetBusinessLocationScreen.dart';
          ...
          child: SafeArea(
            child: Column(
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    //  await model.uploadFileToFirebase();
                    Get.to(() => GetBusinessLocationScreen());
                  },
                  child: CustomGloballyUsedButtonWidget(centerTitle: 'NEXT'),
                ),
              ],
            ),
          ),
