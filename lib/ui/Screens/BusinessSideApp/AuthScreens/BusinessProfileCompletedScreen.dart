...
import 'package:app_876/ui/Screens/BusinessSideApp/HomeScreen/MainBusinessBottomNavigationBar.dart';
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Get.offAll(() => MainBusinessBottomNavigationBar());
                },
                child: CustomGloballyUsedButtonWidget(centerTitle: "Done"),
              )
            ],
          ),
        ),
